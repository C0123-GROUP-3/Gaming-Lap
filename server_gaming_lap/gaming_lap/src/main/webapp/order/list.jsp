    ...
    <div style="display: flex; margin: 8px;position: relative">
      <div>
        ...
        <button class="btn" style="border: 1px solid #DDDDDD"
                onclick="window.location.href='/orderCustomerList'">Add Order
        </button>
      </div>
      <form action="/order_servlet?action=sort" method="post" style="margin-left: 20px">
...
<table id="tableOrder" class="table table-striped table- bordered" style="width: 100%">
  ...
  <c:forEach var="orderList" items="${orderList}" varStatus="status">
    <tr>
      ...
      <td colspan="2">
        <button type="button" onclick="infoUpdate('${orderList.id}')" class="btn btn-warning" data-bs-toggle="modal"
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="update"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/order_servlet?action=update">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/order_servlet?action=delete" method="post">
        <div class="modal-body">
          <input hidden id="deleteId" name="deleteId">
          <span>
                        Bạn có muốn xóa hóa đơn số
                    </span>
